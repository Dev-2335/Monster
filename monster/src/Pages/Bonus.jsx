...
const Bonus = () => {
  ...
  return (
    <div className="bonus-main center-item-column" id='Bonus'>
        ...
        <div className="bonus-content">
          <div className="subContent center-item-column">
            ...
            >
              ...
              <p className="gesrics">
                hey crypto folks here is a NFT contest where you have to buy
                nfts to make sureyou enter the contest. which includes many
                types of nfts with different price tags most loyal holders are
                more eligible for the future airdop and giveaways
              </p>
              {bonusTable1 && (
                <div>
                  <p className="gesrics" style={{ color: "#00ffff" }}>
                    WE WILL PICK RANDOM NFT HOLDERS AND THEY WILL GET HUGE
                    REWARDS{" "}
                  </p>
            ...
            <div
              ...
              onMouseEnter={() =>
                handleHoverIn(setIsBonus1Hovered, setBonusTable1)
              }
            >
        ...
        <div className="bonus-content">
          <div className="subContent center-item-column">
            ...
            >
              ...
              <p className="gesrics">
                THE top 10 the supply holders will get many exCiting AIRDROPS
                AND MANY OTHER REWARDS AFTER THE LAUNCH.
              </p>
              {bonusTable2 && (
                <div>
                  <p className="gesrics" style={{ color: "#00ffff" }}>
                    TOP 10 HOLDERS WILL GET THESE REWARDS{" "}
                  </p>
            ...
            <div
              className="view-prize"
              onMouseEnter={() =>
                handleHoverIn(setIsBonus2Hovered, setBonusTable2)
              }
            >
              <div className="view-prize-content">
                <p className="gesrics" style={{ color: "#00ffff" }}>
